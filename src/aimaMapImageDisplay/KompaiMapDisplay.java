 ...
 */
public class KompaiMapDisplay extends JPanel implements ActionListener
{
...
//	        avoid_obstacle_button.setActionCommand("obstacle");
	        ...
	        base_panel=new JPanel(new GridLayout(1,0));
...
//	  	    navigator_panel.add(left_button);
	  	    ...
	  	    add(base_panel,BorderLayout.CENTER);
	    }
	    ...
	    private static void createAndShowGUI() {
	        ...
	        KompaiMapDisplay newContentPane = new KompaiMapDisplay();
